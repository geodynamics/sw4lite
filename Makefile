...
# LC quartz is a large cluster of Intel Haswell nodes
  ...
  computername := quartz
   ...
   OPT = -O3 -dc -ccbin mpicxx -Xcompiler="-qsmp=omp" -std=c++11 --expt-extended-lambda -restrict -arch=sm_70 -DRAJA03=1 -I$(RAJA_LOCATION)/include  --x cu -DUSE_NVTX -DRAJA_USE_CUDA -DSW4_CROUTINES -DRAJA_USE_RESTRICT_PTR -DCUDA_CODE -DRAJA_ENABLE_NESTED
